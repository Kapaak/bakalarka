  ...
  return (
    <section className="relative bg-gradient-to-r from-main-yellow to-main-orange">
      <MaxWidth className="px-0 md:px-0 lg:px-14">
        <Container height="min-full" className="flex flex-col">
          <NextLink
          ...
          <VerticalStack className="relative z-10 h-full flex-1 rounded-lg bg-transparent before:absolute before:z-negative before:h-full before:w-full before:rounded-lg before:bg-white before:opacity-50 before:content-[''] lg:flex-row-reverse">
            {children}
          </VerticalStack>
        </Container>
      </MaxWidth>
